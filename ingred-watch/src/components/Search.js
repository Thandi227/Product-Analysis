...
submitHandle = event => {
     ...
     axios.post('http://makeup-api.herokuapp.com/api/v1/products.json?brand=clinique', this.state)
     .then(response => {
...
cite: https://reactjs.org/docs/dom-elements.html
    ...
    */
                  ...
                  <button className="icon" type="submit"> <SearchIcon classname="please change" /> </button>
